...
import com.obsinity.collection.spring.scanner.TelemetryEventReceiverScanner;
...
public class HandlerAutoConfiguration {
    ...
    @Bean
    public TelemetryEventReceiverScanner telemetryHolderReceiverScanner(TelemetryHandlerRegistry registry) {
        return new TelemetryEventReceiverScanner(registry);
    }
}
