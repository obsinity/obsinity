...
public class InMemoryEventSender implements EventSender {
  ...
  @Override public void send(byte[] body) throws IOException { payloads.add(body); }
  public List<byte[]> payloads() { return Collections.unmodifiableList(payloads); }
  public void clear() { payloads.clear(); }
}
